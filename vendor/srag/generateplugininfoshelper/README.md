...
```json
  "pre-autoload-dump": [
    ...,
      "srag\\GeneratePluginInfosHelper\\HelpMeCron\\x\\GeneratePluginPhpAndXml::generatePluginPhpAndXml"
    ]
```
...
```json
  "pre-autoload-dump": [
    ...,
     "srag\\GeneratePluginInfosHelper\\HelpMeCron\\x\\GeneratePluginReadme::generatePluginReadme"
    ]
```
...
```json
  "pre-autoload-dump": [
    ...,
     "srag\\GeneratePluginInfosHelper\\HelpMeCron\\x\\UpdatePluginReadme::updatePluginReadme"
    ]
```
