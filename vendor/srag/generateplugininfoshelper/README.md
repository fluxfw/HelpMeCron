...
```php
...
use srag\GeneratePluginInfosHelper\HelpMeCron\x\GeneratePluginPhpAndXml; 
...
...
```php
...
use srag\GeneratePluginInfosHelper\HelpMeCron\x\GeneratePluginReadme; 
...
...
```json
  ...
  "update-version": [
    ...,
     "srag\\GeneratePluginInfosHelper\\HelpMeCron\\x\\UpdateVersion::updateVersion"
    ]
  ...
```
...
```php
...
use srag\GeneratePluginInfosHelper\HelpMeCron\x\UpdateVersion; 
...
